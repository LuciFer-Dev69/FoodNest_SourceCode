...
import {
  ...
  toggleBookmark, getBookmarks, createReport, toggleNotInterested,
...
router.post("/posts", authenticateToken, communityUpload.array("media", 10), createPost);
...
router.put("/posts/:id", authenticateToken, communityUpload.array("media", 10), updatePost);
...
router.post("/posts/:id/not-interested", authenticateToken, toggleNotInterested);
